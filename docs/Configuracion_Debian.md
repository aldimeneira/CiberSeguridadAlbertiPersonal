...
3 Aplicar Cambios y Actualizar la Configuración de GRUB

sudo update-grub

4\. Proteger Permisos del Archivo de Configuración de GRUB

sudo chmod 700 /etc/grub.d/40\_custom

5\. Ocultar el Menú de GRUB: Ejecuta nano y localiza la línea GRUB\_TIMEOUT=. Cámbiála a 0\. Guarda y cierra.

sudo nano /etc/default/grub  
Dentro del archivo, cambia GRUB\_TIMEOUT=5 por GRUB\_TIMEOUT=0

6\. Aplicar Cambios al Ocultar el Menú  
sudo update-grub

7\. Creación de Copia de Seguridad de la Configuración del Arranque
